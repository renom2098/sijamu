...
<script>
    $(document).ready(function(){
        $('#table').DataTable({
            ...
            "serverSide": false,
            "paging": true,
            "ajax": "<?= site_url('auditor/getData_evaluasi'); ?>"
        })
    });
</script>
...
function add()
{
	$.post("<?= site_url("auditor/viewAddDataEvaluasi"); ?>",{},function(data){
		$("#formAdd").html(data);
		$("#modal_edit").attr(
            "url",
            "<?= site_url("auditor/insert_dataEvaluasi"); ?>"
        );
...
function edit(id)
{
	$.post("<?= site_url("auditor/viewEditDataEvaluasi"); ?>",{id:id},function(data){
		$("#formEdit").html(data);
		$("#modal_edit").attr(
            "url",
...
{
    var url = "<?= site_url("auditor/downloadEvaluasi/"); ?>" + id;
	$.post(url);
}
...
function hapus(id,akun)
{
	swal({
		...
		if (willDelete) {
			...
			$.post("<?= site_url("auditor/delete_dataEvaluasi"); ?>",{id:id},function(){
			reload_data();
			});
